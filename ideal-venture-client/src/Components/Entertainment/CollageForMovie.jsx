...
const CollageForMovie = () => {
  const setting = {
    ...
    photos: [
      ...
      {
        source:
          "https://images.unsplash.com/photo-1645670533175-d7a1c1df849e?ixlib=rb-1.2.1&ixid=MnwxMjA3fDB8MHxwaG90by1wYWdlfHx8fGVufDB8fHx8&auto=format&fit=crop&w=2906&q=80",
      },
      {
        source:
          "https://images.unsplash.com/photo-1523038793606-2fd28f837a85?ixlib=rb-0.3.5&ixid=eyJhcHBfaWQiOjEyMDd9&s=919b76f4229e41416653aeb10e84e94a&auto=format&fit=crop&w=334&q=80",
  ...
  return (
    <div>
      <div style={{ height: "100%", paddingTop: "11vh" }}>
...
export default CollageForMovie;
